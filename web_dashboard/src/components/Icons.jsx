...
export function IconLogo({ size = 20, color = '#FFFFFF' }) {
  return (
...
export function IconCheck({ size = 16, color = '#2E7D32' }) {
  return (
...
export function IconCross({ size = 16, color = '#C62828' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
export function IconAlert({ size = 16, color = '#D97706' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconInfo({ size = 16, color = '#00897B' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconChevronUp({ size = 14, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
